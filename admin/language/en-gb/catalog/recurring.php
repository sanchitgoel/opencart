...
$_['text_month']            = 'Month';
$_['text_year']             = 'Year';
$_['text_recurring']        = '<span style="width:25px;float:left;"><i class="fa fa-info-circle fa-lg" style="color: #47beaf;font-size: 18px;"></i></span><div class="col-xs-11 noPadding"><p style="font-weight:600;margin:0 0 3px 0;">Recurring amounts are calculated by the frequency and cycles.</p><p style="font-size: 11px;margin:0;">For example if you use a frequency of "week" and a cycle of "2", then the user will be billed every 2 weeks.</p><p style="font-size: 11px;margin:0;">The duration is the number of times the user will make a payment, set this to 0 if you want payments until they are cancelled.</p></div>';
